...
class ReadersWritersMonitor:
    ...
    def end_write(self, writer_id: int) -> None:
        ...
        with self.condition:
            # TODO: Replace 'pass' with your logic
            # writers left, decrease active_writers
            self.active_writers -= 1
            print(f"Writer {writer_id} finished writing")
            # if last writer, wake waiting readers
